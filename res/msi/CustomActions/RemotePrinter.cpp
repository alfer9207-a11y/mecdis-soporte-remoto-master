...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\MecDisPrinterDriver\\MecDisPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"MecDis Printer";
    LPCWCH RD_PRINTER_NAME = L"MecDis Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"MecDis v4 Printer Driver";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through MecDis Printer.
