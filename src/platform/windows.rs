...
pub fn bootstrap() -> bool {
    ...
    #[cfg(not(debug_assertions))]
    {
        // This function will cause `'sciter.dll' was not found neither in PATH nor near the current executable.` when debugging MecDis.
...
fn get_pids_with_args_from_wmic_output<S2: AsRef<str>>(
    ...
    // ProcessId=34668
    //
    // CommandLine="C:\Program Files\MecDis\MecDis.exe" --tray
    // ProcessId=13728
    //
    // CommandLine="C:\Program Files\MecDis\MecDis.exe"
    // ProcessId=10136
    let mut pids = Vec::new();
