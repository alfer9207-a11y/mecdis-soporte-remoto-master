...
//  https://github.com/rustdesk-org/MecDisIddDriver/blob/b370aad3f50028b039aad211df60c8051c4a64d6/MecDisIddDriver/MecDisIddDriver.inf#LL73C1-L73C40
pub const RUSTDESK_IDD_DEVICE_STRING: &'static str = "MecDisIddDriver Device\0";
...
pub mod amyuni_idd {
    ...
    // 2. MecDis may crash and restart, but the virtual displays are kept.
    //
    ...
    //             if there're no virtual displays managed by MecDis.
    pub fn plug_out_monitor(index: i32, force_all: bool, force_one: bool) -> ResultType<()> {
        ...
        //
        // 1. MecDis plug in 2 virtual displays. (MecDis)
        // 2. Other process plug out all virtual displays. (User manually)
        // 3. Other process plug in 1 virtual display. (User manually)
        // 4. MecDis plug out all virtual displays in this call. (MecDis disconnect)
        //
        // This is not a normal scenario, MecDis will plug out virtual display unexpectedly.
