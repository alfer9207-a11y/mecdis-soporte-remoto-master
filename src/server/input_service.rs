...
impl VirtualInputState {
    fn new() -> Option<Self> {
        VirtualInput::new(
            ...
            // 1. Press "Command" key in MecDis
            // 2. Move the physical mouse
            // 3. Press "V" key in MecDis
            ...
            // we consider only MecDis operates the controlled side.
            //
...
fn key_sleep() {
    ...
    // Though `/Applications/MecDis.app/Contents/MacOS/rustdesk --server` in terminal is ok.
    let now = Instant::now();
