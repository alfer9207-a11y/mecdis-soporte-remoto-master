...
MecDis er åpene for bidrag fra alle. Her er reglene for de som har lyst til å
hjelpe oss:

## Bidrag

Bidrag til MecDis eller deres avhengigheter burde være i form av GitHub pull requests.
...
MecDis bidragere burker [Discord](https://discord.gg/nDceKgxnkV).
