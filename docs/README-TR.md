...
<p align="center">
  <img src="../res/logo-header.svg" alt="MecDis - Uzak masaüstü uygulamanız"><br>
  ...
  <b>README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">MecDis UI</a> ve <a href="https://github.com/rustdesk/doc.rustdesk.com">MecDis Dökümantasyonu</a>'nu ana dilinize çevirmemiz için yardımınıza ihtiyacımız var</b>
</p>


> [!Dikkat]
> **Yanlış Kullanım Uyarısı:** <br>
> MecDis geliştiricileri, bu yazılımın etik olmayan veya yasa dışı kullanımını onaylamaz veya desteklemez. Yetkisiz erişim, kontrol veya gizlilik ihlali gibi kötüye kullanımlar kesinlikle yönergelerimize aykırıdır. Yazarlar, uygulamanın herhangi bir yanlış kullanımından sorumlu değildir.
...
[![MecDis Server Pro](https://img.shields.io/badge/MecDis%20Server%20Pro-Geli%C5%9Fmi%C5%9F%20%C3%96zellikler-blue)](https://rustdesk.com/pricing.html)
...
MecDis, herkesin katkısına açıktır. Başlamak için [CONTRIBUTING.md](CONTRIBUTING-TR.md) belgesine göz atın.
