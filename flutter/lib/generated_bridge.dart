...
class RustdeskWire implements FlutterRustBridgeWireBase {
  ...
  bool mecdis_core_main() {
    return _mecdis_core_main();
  }

  late final _mecdis_core_mainPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function()>>('mecdis_core_main');
  late final _mecdis_core_main =
      _mecdis_core_mainPtr.asFunction<bool Function()>();
  ...
  ffi.Pointer<ffi.Pointer<ffi.Char>> mecdis_core_main_args(
    ffi.Pointer<ffi.Int> args_len,
  ) {
    return _mecdis_core_main_args(
      args_len,
    );
  }

  late final _mecdis_core_main_argsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Pointer<ffi.Char>> Function(
              ffi.Pointer<ffi.Int>)>>('mecdis_core_main_args');
  late final _mecdis_core_main_args = _mecdis_core_main_argsPtr.asFunction<
  ...
  int get_mecdis_app_name(
    ffi.Pointer<ffi.Uint16> buffer,
    int length,
  ) {
    return _get_mecdis_app_name(
      buffer,
      length,
    );
  }

  late final _get_mecdis_app_namePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<ffi.Uint16>, ffi.Int32)>>('get_mecdis_app_name');
  late final _get_mecdis_app_name = _get_mecdis_app_namePtr
