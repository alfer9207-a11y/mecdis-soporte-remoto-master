...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsMecDisVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsMecDisVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsMecDisVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get MecDisVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsMecDisVirtualDisplays] ?? []);
